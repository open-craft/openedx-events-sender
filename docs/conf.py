...
"""
openedx-events-sender documentation build configuration file.
...
project = 'openedx-events-sender'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'openedx-events-sender'
...
#
# html_title = 'openedx-events-sender v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'Send Open edX events to selected URLs.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'openedx_events_sender'),
                os.path.join(root_path, 'openedx_events_sender/migrations')])
